...
const SAMPLE_PREVIEWS: Record<string, { q: string; a: string }> = {
  tactician: {
    q: 'How should Canada set up vs. a high press?',
    a: 'Switch to a 4-5-1 mid-block, invite pressure wide, and exploit the channels with Eustáquio threading through-balls...',
  },
  'data-scientist': {
    q: "What's Belgium's xG trend in knockouts?",
    a: 'Belgium avg xG 1.4 per knockout game at WC2022, but their xGA (0.8) tells the real story — elite defensive shape...',
  },
  fantasy: {
    q: 'Best budget pick for WC fantasy?',
    a: 'Akira Ueda (Japan) is massively under-priced at 4.5M. Plays in all group games, high chance of clean sheet bonus...',
  },
  referee: {
    q: 'Was that handball a penalty under IFAB?',
    a: 'Under Law 12, the arm must be in an "unnatural position" — if the arm extended above shoulder during the cross, yes: penalty.',
  },
  historian: {
    q: 'Greatest World Cup upset of all time?',
    a: 'USA 1-0 England in 1950. A part-time postman scored the only goal. The English press thought the scoreline was a typo.',
  },
  scout: {
    q: 'Name a wonderkid to watch in 2026?',
    a: "Endrick (Brazil) will be 20 at tournament time. Already showing elite movement in tight areas — could be the tournament's breakout star.",
  },
  commentator: {
    q: 'Build the Final as a commentator!',
    a: "AND IT'S THERE! A LATE WINNER! THE STADIUM HAS ERUPTED — 87,000 souls witnessing history as the ball hits the net in injury time...",
  },
  fan: {
    q: "What's your prediction?",
    a: "Brazil or bust, always. Anyone who says otherwise hasn't watched football. The Seleção are built DIFFERENT this cycle, trust me fam 🇧🇷🔥",
  },
};
            ...
            >
              ...
              >
                ...
                <div className="relative flex-1 text-center md:text-left">
                  ...
                  <h3 className="font-display text-4xl md:text-6xl text-[var(--text)] mb-2 tracking-tighter">
                    {agentOfTheDay.name}
                  </h3>
                  <p className="text-lg font-bold uppercase tracking-[0.3em] text-[var(--accent)] mb-4">
                    {agentOfTheDay.role}
                  </p>
                  <p className="text-[var(--text-2)] text-base md:text-lg leading-relaxed mb-8 max-w-2xl balance">
                    {agentOfTheDay.description} Available for deep architectural
                    analysis and predictive modelling of the upcoming fixtures.
                  </p>
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 mb-4">
                    <h3 className="font-display text-xl text-[var(--text)] leading-tight mb-1">
                      {agent.name}
                    </h3>
                    <p className="text-[10px] font-black text-[var(--accent)] tracking-[0.2em] uppercase opacity-80">
                      {agent.role}
                    </p>
                  </div>

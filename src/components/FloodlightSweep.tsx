    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'radial-gradient(ellipse at 50% 0%, rgba(255,255,200,0.06) 0%, transparent 70%)',
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(105deg, transparent 0%, rgba(255,255,220,0.18) 45%, rgba(255,255,200,0.22) 50%, rgba(255,255,220,0.18) 55%, transparent 100%)',
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            'linear-gradient(100deg, transparent 0%, rgba(200,240,255,0.10) 45%, rgba(220,245,255,0.14) 50%, rgba(200,240,255,0.10) 55%, transparent 100%)',
      ...
      <div
        style={{
          ...
          height: '60vh',
          background:
            'linear-gradient(180deg, rgba(255,255,200,0.5) 0%, transparent 100%)',
